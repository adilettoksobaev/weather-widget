                    ...
                    .map((item, i) => (
                        <div 
                            ...
                            <div className="weather-box">
                                <div className="weather-box__title">
                                    <span>{item.city}, {item.country}</span>
                                    {i === 0 && 
                                        <NavLink to='/settings'>
                                            <svg className="settings-icon" focusable="false" viewBox="0 0 24 24" aria-hidden="true" aria-describedby="mui-19791">
                                ...
                                <div className="weather-box__condition">
                                    ...
                                    <div className="weather-box__celsius">
                                        {item.celsius} &deg; c
                                    </div>
                                </div>
                                <div className="weather-box__info">
                                    <div className="row">
                                        <div className="col col-12">
                                            <div className="weather-box__text desc">
                                                Feels like {item.feelsLike} &deg; C. {item.description}. {item.main}.
                                            </div>
                                        </div>
                                        <div className="col col-6">
                                            <div className="weather-box__content">
                                                <svg className="weather-box__icon rotate" focusable="false" viewBox="0 0 24 24" aria-hidden="true" aria-describedby="mui-53193">
                                        ...
                                        <div className="col col-6">
                                            <div className="weather-box__content">
                                                <svg className="weather-box__icon" focusable="false" viewBox="0 0 24 24" aria-hidden="true" aria-describedby="mui-67105">
                                        ...
                                        <div className="col col-6">
                                            <div className="weather-box__text">
                                                Humidity: {item.humidity}%
                                            </div>
                                        </div>
                                        <div className="col col-6">
                                            <div className="weather-box__text">
                                                Dew point: {item.dewPoint} &deg; C
                                            </div>
                                        </div>
                                        <div className="col col-6">
                                            <div className="weather-box__text">
